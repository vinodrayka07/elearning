...
class AddEventPageView extends GetView<AddEventPageController> {
  const AddEventPageView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(AddEventPageController());
...
Future<void> show(BuildContext context, AddEventPageController controller)  async{
