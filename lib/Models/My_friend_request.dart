class MyFriendRequest {
  String? status;
  String? message;
  List<NewNewResult>? result;

  MyFriendRequest({this.status, this.message, this.result});

  MyFriendRequest.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['result'] != null) {
      result = <NewNewResult>[];
      json['result'].forEach((v) {
        result!.add(new NewNewResult.fromJson(v));
      });
    }
  }
...
class NewNewResult {
  ...
  NewNewResult({this.id, this.userId, this.requestId, this.status, this.userData});

  NewNewResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
